...
<h1 class="text-9 font-bold" style="margin-top: 40px;">Tambah Dosen</h1>
...
<form action="/tambah_dosen/save" method="post" class="w-180" enctype="multipart/form-data">
    ...
    <input type="text" name="nama" id="nama" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
    <div class="h-3"></div>
    <label for="nidn" class="block mb-2 text-sm font-medium text-gray-900">NIDN:</label>
    <textarea name="nidn" id="nidn" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "></textarea>
    <div class="h-3"></div>
    <label for="deskripsi" class="block mb-2 text-sm font-medium text-gray-900">Deskripsi:</label>
    <textarea name="deskripsi" id="deskripsi" rows="10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "></textarea>
    <div class="h-3"></div>
    <label for="kelas" class="block mb-2 text-sm font-medium text-gray-900">Kelas:</label>
    <textarea name="kelas" id="kelas" rows="10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "></textarea>
    <div class="h-3"></div>
    <label for="mk" class="block mb-2 text-sm font-medium text-gray-900">Mata Kuliah:</label>
    <textarea name="mk" id="mk" rows="10" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "></textarea>
    <div class="h-3"></div>
