...
<h1 class="text-9 font-bold mt-[40px] mb-10">Manajemen Dosen</h1>
<div class="relative overflow-x-auto overflow-y-auto max-h-[500px] shadow-md sm:rounded-lg bg-blue-800">
    <div class="flex justify-start mt-4 mb-4">
        <a href="/manajemen_dosen/tambah_dosen" class="flex gap-1 bg-green-400 hover:bg-white items-center text-black rounded-lg font-montserrat font-medium py-2 px-4" style="margin-left: 12px;">
            Add
    ...
    <form action="/manajemen_dosen" method="GET" class="mb-4">
    ...
    <a href="/manajemen_dosen" class="text-blue-500 hover:text-blue-700">
                ...
                <tr class="<?= $index % 2 === 0 ? 'bg-white' : 'bg-white' ?> border-b mr-6">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-center">
                            <div class="flex justify-center">
                                <a class="mr-2" href="/manajemen_dosen/edit_dosen/<?= $r['id']; ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-blue-600">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                    </svg>
                                </a>
                                <a class="mr-2" href="/manajemen_dosen/delete_dosen/<?= $r['id']; ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-red-500" onclick="return confirm('Are you sure you want to delete this Dosen?');">
